...
![Version](https://img.shields.io/badge/version-5.3.0-brightgreen.svg)
...
## 设计风格（自 v5.3.0 起为极简风格）

**从 v5.3.0 开始，软件全面转向极简设计**：
...
- 首页只保留功能卡片与轻量欢迎条，移除贴士卡、横幅等冗余装饰，排版宽松、留白充足
...
| 个性化 | 多套主题（默认 / 绿 / 橙 / 紫 / 粉 / 青 / 星空 / 极光）、背景壁纸、点击动画 |
...
### 方式一：直接下载运行
从 [Releases](../../releases) 下载 `司南工具箱_Setup_v5.3.0.exe`（安装包）或 `司南工具箱.exe`（绿色单文件），在 Windows 10/11 x64 上双击即可运行。
